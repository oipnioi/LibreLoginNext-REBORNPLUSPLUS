...
package xyz.miguvt.miguloginnext.api;
...
import xyz.miguvt.miguloginnext.api.event.EventTypes;
import xyz.miguvt.miguloginnext.api.image.ImageProjector;
import xyz.miguvt.miguloginnext.api.integration.LimboIntegration;
import xyz.miguvt.miguloginnext.api.mail.EmailHandler;
import xyz.miguvt.miguloginnext.api.premium.PremiumProvider;
 ...
 */
public interface MiguLoginNextPlugin<P, S> {
     ...
     * @param clazz   The class the connector will be registered for. (e.g. {@link xyz.miguvt.miguloginnext.api.database.connector.MySQLDatabaseConnector})
