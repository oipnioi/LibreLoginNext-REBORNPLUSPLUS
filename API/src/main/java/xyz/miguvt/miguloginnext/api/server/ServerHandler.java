...
package xyz.miguvt.miguloginnext.api.server;
...
public interface ServerHandler<P, S> {
     ...
     * @throws xyz.miguvt.miguloginnext.api.event.exception.EventCancelledException If lobby choose event is cancelled
