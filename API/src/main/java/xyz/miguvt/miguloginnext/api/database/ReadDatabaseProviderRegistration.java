...
package xyz.miguvt.miguloginnext.api.database;
 ...
 * @param id                the id of the provider, suggested format: "plugin_name-connector_id" (e.g. "miguloginnext-mysql", or "authme-sqlite")
