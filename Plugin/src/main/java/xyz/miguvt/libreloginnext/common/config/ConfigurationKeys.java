...
package xyz.miguvt.libreloginnext.common.config;

import com.google.common.collect.HashMultimap;
import com.google.common.collect.Multimap;

import xyz.miguvt.libreloginnext.common.authorization.ProfileConflictResolutionStrategy;
...
public class ConfigurationKeys {
    ...
    public static final ConfigurationKey<String> DATABASE_TYPE = new ConfigurationKey<>(
            ...
            """
                    ...
                    libreloginnext-mysql - MySQL database, you must fill out the mysql section below.
                    libreloginnext-postgresql - PostgreSQL database, you must fill out the postgresql section below.
                    libreloginnext-sqlite - SQLite database, default file is "database.db", you can change it in the sqlite section below.
                    """,
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> MIGRATION_TYPE = new ConfigurationKey<>(
            ...
            """
                    ...
                    libreloginnext-mysql - Can convert from MySQL LibreLoginNext (or LibreLogin), useful for migrating to a different database
                    libreloginnext-sqlite - Can convert from SQLite LibreLoginNext (or LibreLogin), useful for migrating to a different database
                    """,
            ConfigurateHelper::getString
    );
