...
public class BungeeCordListener extends AuthenticListeners<BungeeCordMiguLoginNext, ProxiedPlayer, ServerInfo> implements Listener {

    public BungeeCordListener(BungeeCordMiguLoginNext plugin) {
        super(plugin);
    }
