...
public class VelocityListeners extends AuthenticListeners<VelocityMiguLoginNext, Player, RegisteredServer> {
    ...
    public VelocityListeners(VelocityMiguLoginNext plugin) {
        super(plugin);
    }
    ...
    public void onPreLogin(PreLoginEvent event) {
        ...
        if (plugin.floodgateEnabled()) {
            ...
            try {
                ...
                e.printStackTrace();
                event.setResult(PreLoginEvent.PreLoginComponentResult.denied(Component.text("Internal MiguLoginNext error")));
                return;
            }
        }
