...
import static xyz.miguvt.miguloginnext.common.AuthenticMiguLoginNext.DATE_TIME_FORMATTER;
import static xyz.miguvt.miguloginnext.common.AuthenticMiguLoginNext.GSON;
...
@CommandAlias("miguloginnext|librelogin")
public class MiguLoginNextCommand<P> extends StaffCommand<P> {

    public MiguLoginNextCommand(AuthenticMiguLoginNext<P, ?> plugin) {
        super(plugin);
    }
    ...
    @CommandPermission("miguloginnext.email.test")
    ...
    @Subcommand("dump")
    @CommandPermission("miguloginnext.dump")
    ...
    @CommandPermission("miguloginnext.reload.configuration")
    ...
    @CommandPermission("miguloginnext.reload.messages")
    ...
    @CommandPermission("miguloginnext.user.info")
    ...
    public static <P> void enablePremium(P player, User user, AuthenticMiguLoginNext<P, ?> plugin, boolean onlyValid) {
        var id = plugin.getUserOrThrowICA(user.getLastNickname());

        if (onlyValid && id != null && !id.reliable()) {
            plugin.getLogger().warn("Data retrieved from premium provider is not reliable for user %s, can not safely enable premium login. \nPlease verify the correct capitalization using site such as NameMC and then enable it manually using the /miguloginnext user premium command.".formatted(user.getLastNickname()));
    ...
    @CommandPermission("miguloginnext.user.migrate")
    ...
    @CommandPermission("miguloginnext.user.unregister")
    ...
    @CommandPermission("miguloginnext.user.delete")
    ...
    @CommandPermission("miguloginnext.user.premium")
    ...
    @CommandPermission("miguloginnext.user.cracked")
    ...
    @CommandPermission("miguloginnext.user.register")
    ...
    @CommandPermission("miguloginnext.user.login")
    ...
    @CommandPermission("miguloginnext.user.2faoff")
    ...
    @CommandPermission("miguloginnext.user.emailoff")
    ...
    @CommandPermission("miguloginnext.user.setemail")
    ...
    @CommandPermission("miguloginnext.user.pass-change")
    ...
    @CommandPermission("miguloginnext.user.alts")
