...
public class ConfigurationKeys {
    ...
    public static final ConfigurationKey<Boolean> IGNORE_MAX_PLAYERS_FROM_BACKEND_PING = new ConfigurationKey<>(
            ...
            false,
            """
                    By default, when choosing available lobby/limbos MiguLoginNext will rule out all the servers which are full.
    ...
    public static final ConfigurationKey<String> NEW_UUID_CREATOR = new ConfigurationKey<>(
            ...
            """
                    ...
                    See the wiki for further information: https://github.com/MiguVerse/MiguLoginNext/wiki/UUID-Creators
                    Available Creators:
    ...
    public static final ConfigurationKey<String> DATABASE_TYPE = new ConfigurationKey<>(
            ...
            """
                    ...
                    miguloginnext-mysql - MySQL database, you must fill out the mysql section below.
                    miguloginnext-postgresql - PostgreSQL database, you must fill out the postgresql section below.
                    miguloginnext-sqlite - SQLite database, default file is "database.db", you can change it in the sqlite section below.
                    """,
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<?> MIGRATION = ConfigurationKey.createCommentKey(
            ...
            """
                    ...
                    Please see the wiki for further information: https://github.com/MiguVerse/MiguLoginNext/wiki/Database-Migration
                    """
    );
    ...
    public static final ConfigurationKey<String> MIGRATION_TYPE = new ConfigurationKey<>(
            ...
            """
                    ...
                    miguloginnext-mysql - Can convert from MySQL MiguLoginNext (or LibreLogin), useful for migrating to a different database
                    miguloginnext-sqlite - Can convert from SQLite MiguLoginNext (or LibreLogin), useful for migrating to a different database
                    """,
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<?> TOTP = ConfigurationKey.createCommentKey(
            ...
            """
                    ...
                    You can find more information on the wiki: https://github.com/MiguVerse/MiguLoginNext/wiki/2FA
                    """
    );
    ...
    public static final ConfigurationKey<Boolean> TOTP_ENABLED = new ConfigurationKey<>(
            ...
            """
                    ...
                    I heavily suggest you to read this wiki page: https://github.com/MiguVerse/MiguLoginNext/wiki/2FA
                    """,
            ConfigurateHelper::getBoolean
    );
    ...
    public static final ConfigurationKey<Boolean> ALLOW_PROXY_CONNECTIONS = new ConfigurationKey<>(
            ...
            """
                    ...
                    Verifies whether the IP the players had used when authenticating to Mojang matches the IP they are connecting from. Disabling this may break MiguLoginNext if the server is running under a reverse proxy/VPN.
                    """,
            ConfigurateHelper::getBoolean
    );
