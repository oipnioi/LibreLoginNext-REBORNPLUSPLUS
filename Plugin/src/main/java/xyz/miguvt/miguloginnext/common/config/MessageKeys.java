...
public class MessageKeys {
    ...
    public static final ConfigurationKey<String> KICK_INVALID_CASE_USERNAME = new ConfigurationKey<>(
            ...
            """
                    ...
                    See https://github.com/MiguVerse/MiguLoginNext/wiki/Name-Validation for more information.""",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> KICK_NAME_MISMATCH = new ConfigurationKey<>(
            ...
            """
                    ...
                    See https://github.com/MiguVerse/MiguLoginNext/wiki/Profile-Conflicts for more information.""",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> INFO_DUMPING = new ConfigurationKey<>(
            "info-dumping",
            "Creating dump...",
            "This message is displayed when a user executes /miguloginnext dump.",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> INFO_ABOUT = new ConfigurationKey<>(
            "info-about",
            """
                    This server is running FOSS authentication plugin, MiguLoginNext.
                    Version: %version%
                    Authors: miguvt, kyngs, and other contributors
                    Source: https://github.com/MiguVerse/MiguLoginNext
                    License: Mozilla Public License 2.0""",
            """
                    This message is displayed when the player executes /miguloginnext about.
    ...
    public static final ConfigurationKey<String> AUTOCOMPLETE_USER_INFO = new ConfigurationKey<>(
            ...
            "@players",
            "This hint is displayed when the player starts typing the /miguloginnext user info command.",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> AUTOCOMPLETE_USER_MIGRATE = new ConfigurationKey<>(
            ...
            "@players newName",
            "This hint is displayed when the player starts typing the /miguloginnext user migrate command.",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> AUTOCOMPLETE_USER_UNREGISTER = new ConfigurationKey<>(
            ...
            "@players",
            "This hint is displayed when the player starts typing the /miguloginnext user unregister command.",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> AUTOCOMPLETE_USER_DELETE = new ConfigurationKey<>(
            ...
            "@players",
            "This hint is displayed when the player starts typing the /miguloginnext user delete command.",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> AUTOCOMPLETE_USER_PREMIUM = new ConfigurationKey<>(
            ...
            "@players",
            "This hint is displayed when the player starts typing the /miguloginnext user premium command.",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> AUTOCOMPLETE_USER_CRACKED = new ConfigurationKey<>(
            ...
            "@players",
            "This hint is displayed when the player starts typing the /miguloginnext user cracked command.",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> AUTOCOMPLETE_USER_REGISTER = new ConfigurationKey<>(
            ...
            "@players password",
            "This hint is displayed when the player starts typing the /miguloginnext user register command.",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> AUTOCOMPLETE_USER_LOGIN = new ConfigurationKey<>(
            ...
            "@players",
            "This hint is displayed when the player starts typing the /miguloginnext user login command.",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> AUTOCOMPLETE_USER_2FA_OFF = new ConfigurationKey<>(
            ...
            "@players",
            "This hint is displayed when the player starts typing the /miguloginnext user 2fa-off command.",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> AUTOCOMPLETE_USER_EMAIL_OFF = new ConfigurationKey<>(
            ...
            "@players",
            "This hint is displayed when the player starts typing the /miguloginnext user emailoff command.",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> AUTOCOMPLETE_USER_SET_EMAIL = new ConfigurationKey<>(
            ...
            "@players email",
            "This hint is displayed when the player starts typing the /miguloginnext user setemail command.",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> AUTOCOMPLETE_USER_ALTS = new ConfigurationKey<>(
            ...
            "@players",
            "This hint is displayed when the player starts typing the /miguloginnext user alts command.",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> AUTOCOMPLETE_USER_CHANGE_PASSWORD = new ConfigurationKey<>(
            ...
            "@players newPassword",
            "This hint is displayed when the player starts typing the /miguloginnext user pass-change command.",
            ConfigurateHelper::getString
    );
    ...
    public static final ConfigurationKey<String> AUTOCOMPLETE_EMAIL_TEST = new ConfigurationKey<>(
            ...
            "address",
            "This hint is displayed when the player starts typing the /miguloginnext email test command.",
            ConfigurateHelper::getString
    );
