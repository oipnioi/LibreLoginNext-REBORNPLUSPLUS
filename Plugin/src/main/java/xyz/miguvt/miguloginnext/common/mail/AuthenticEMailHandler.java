...
package xyz.miguvt.miguloginnext.common.mail;
...
public class AuthenticEMailHandler implements EmailHandler {
    ...
    public AuthenticEMailHandler(AuthenticMiguLoginNext<?, ?> plugin) {
        this.plugin = plugin;
    }
    ...
    public void sendTestMail(String email) {
        sendEmail(email, "MiguLoginNext test mail", """
                Congratulations! You have successfully configured email sending in MiguLoginNext!<br>
