...
import xyz.miguvt.miguloginnext.common.command.CommandProvider;
import xyz.miguvt.miguloginnext.common.command.InvalidCommandArgument;
import xyz.miguvt.miguloginnext.common.config.HoconMessages;
import xyz.miguvt.miguloginnext.common.config.HoconPluginConfiguration;
import xyz.miguvt.miguloginnext.common.crypto.Argon2IDCryptoProvider;
import xyz.miguvt.miguloginnext.common.crypto.BCrypt2ACryptoProvider;
import xyz.miguvt.miguloginnext.common.crypto.LogITMessageDigestCryptoProvider;
import xyz.miguvt.miguloginnext.common.crypto.MessageDigestCryptoProvider;
import xyz.miguvt.miguloginnext.common.database.AuthenticDatabaseProvider;
...
import xyz.miguvt.miguloginnext.common.database.connector.AuthenticPostgreSQLDatabaseConnector;
import xyz.miguvt.miguloginnext.common.database.connector.AuthenticSQLiteDatabaseConnector;
import xyz.miguvt.miguloginnext.common.database.connector.DatabaseConnectorRegistration;
import xyz.miguvt.miguloginnext.common.database.provider.MiguLoginNextMySQLDatabaseProvider;
import xyz.miguvt.miguloginnext.common.database.provider.MiguLoginNextPostgreSQLDatabaseProvider;
import xyz.miguvt.miguloginnext.common.database.provider.MiguLoginNextSQLiteDatabaseProvider;
import xyz.miguvt.miguloginnext.common.event.AuthenticEventProvider;
import xyz.miguvt.miguloginnext.common.image.AuthenticImageProjector;
import xyz.miguvt.miguloginnext.common.integration.FloodgateIntegration;
import xyz.miguvt.miguloginnext.common.integration.luckperms.LuckPermsIntegration;
import xyz.miguvt.miguloginnext.common.listener.LoginTryListener;
import xyz.miguvt.miguloginnext.common.log.Log4JFilter;
import xyz.miguvt.miguloginnext.common.log.SimpleLogFilter;
import xyz.miguvt.miguloginnext.common.mail.AuthenticEMailHandler;
import xyz.miguvt.miguloginnext.common.migrate.*;
import xyz.miguvt.miguloginnext.common.premium.AuthenticPremiumProvider;
import xyz.miguvt.miguloginnext.common.server.AuthenticServerHandler;
import xyz.miguvt.miguloginnext.common.totp.AuthenticTOTPProvider;
...
import xyz.miguvt.miguloginnext.api.database.*;
...
public abstract class AuthenticMiguLoginNext<P, S> implements MiguLoginNextPlugin<P, S> {
    ...
    protected AuthenticMiguLoginNext() {
        ...
        for (String oldName : oldFolderNames) {
            ...
            if (oldFolder.exists() && (configFile.exists() || messagesFile.exists())) {
                ...
                try {
                    ...
                    logger.info("Successfully migrated from '" + oldName + "' folder to 'MiguLoginNext'.");
    ...
    private void setupDB() {
        ...
        registerReadProvider(new ReadDatabaseProviderRegistration<>(
                connector -> new MiguLoginNextMySQLDatabaseProvider(connector, this),
                "miguloginnext-mysql",
                MySQLDatabaseConnector.class
        ));
        registerReadProvider(new ReadDatabaseProviderRegistration<>(
                connector -> new MiguLoginNextSQLiteDatabaseProvider(connector, this),
                "miguloginnext-sqlite",
                SQLiteDatabaseConnector.class
        ));
        registerReadProvider(new ReadDatabaseProviderRegistration<>(
                connector -> new MiguLoginNextPostgreSQLDatabaseProvider(connector, this),
                "miguloginnext-postgresql",
                PostgreSQLDatabaseConnector.class
        ));
        registerReadProvider(new ReadDatabaseProviderRegistration<>(
    ...
    private void loadForbiddenPasswords() throws IOException {
        ...
        if (!file.exists()) {
            ...
            try (BufferedInputStream in = new BufferedInputStream(URI.create("https://raw.githubusercontent.com/MiguVerse/MiguLoginNext/dev/forbidden-passwords.txt").toURL().openStream())) {
    ...
    private void checkForUpdates() {
        ...
        try {
            var connection = URI.create("https://api.github.com/repos/MiguVerse/MiguLoginNext/releases").toURL().openConnection();

            connection.setRequestProperty("User-Agent", "MiguLoginNext");
