...
import xyz.miguvt.miguloginnext.common.authorization.ProfileConflictResolutionStrategy;
...
import xyz.miguvt.miguloginnext.common.event.events.AuthenticAuthenticatedEvent;
...
public class AuthenticListeners<Plugin extends AuthenticMiguLoginNext<P, S>, P, S> {
