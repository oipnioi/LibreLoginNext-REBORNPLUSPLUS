...
import xyz.miguvt.miguloginnext.common.config.migrate.messages.FirstMessagesMigrator;
import xyz.miguvt.miguloginnext.common.config.migrate.messages.SecondMessagesMigrator;
import xyz.miguvt.miguloginnext.common.config.migrate.messages.ThirdMessagesMigrator;
...
public class HoconMessages implements Messages {
    ...
    @Override
    public void reload(MiguLoginNextPlugin<?, ?> plugin) throws IOException, CorruptedConfigurationException {
