...
public class AuthenticMySQLDatabaseConnector extends AuthenticDatabaseConnector<SQLException, Connection> implements MySQLDatabaseConnector {
    ...
    public AuthenticMySQLDatabaseConnector(AuthenticMiguLoginNext<?, ?> plugin, String prefix) {
        super(plugin, prefix);

        this.hikariConfig = new HikariConfig();

        hikariConfig.setPoolName("MiguLoginNext MySQL Pool");
        hikariConfig.setDriverClassName("xyz.miguvt.miguloginnext.lib.mariadb.jdbc.Driver");
